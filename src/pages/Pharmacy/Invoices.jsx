...
const PharmacyInvoices = () => {
  ...
  const stats = [
    ...
    { label: 'Total Due', value: `Rs. ${totalAmount.toLocaleString()}`, color: 'orange' },
    { label: 'Total Paid', value: `Rs. ${totalPaid.toLocaleString()}`, color: 'green' },
      ...
      <div className="dashboard-content">
        ...
        <div className="place-order">
          <div className="page-header">
            <h1>Invoices</h1>
            <p className="subtitle">View and manage your invoices</p>
          </div>
          ...
          <div className="order-controls" style={{ marginBottom: '24px' }}>
            <input
              type="text"
              placeholder="Search invoice ID, order ID or distributor..."
              value={searchTerm}
          ...
          {/* Invoices Table */}
          <div style={{ backgroundColor: 'white', borderRadius: '12px', boxShadow: 'var(--shadow-sm)', overflow: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead style={{ backgroundColor: 'var(--bg-secondary)', borderBottom: '2px solid var(--border)' }}>
                <tr>
                  <th style={{ padding: '16px', textAlign: 'left', fontWeight: 600 }}>Invoice ID</th>
                  <th style={{ padding: '16px', textAlign: 'left', fontWeight: 600 }}>Order ID</th>
                  <th style={{ padding: '16px', textAlign: 'left', fontWeight: 600 }}>Distributor</th>
                  <th style={{ padding: '16px', textAlign: 'center', fontWeight: 600 }}>Amount</th>
                  <th style={{ padding: '16px', textAlign: 'center', fontWeight: 600 }}>Paid</th>
                  <th style={{ padding: '16px', textAlign: 'center', fontWeight: 600 }}>Status</th>
                  <th style={{ padding: '16px', textAlign: 'center', fontWeight: 600 }}>Due Date</th>
              ...
              <tbody>
                {filteredInvoices.map((invoice) => (
                  <tr key={invoice.id} style={{ borderBottom: '1px solid var(--border)' }}>
                    ...
                    <td style={{ padding: '16px' }}>{invoice.distributorName}</td>
                    <td style={{ padding: '16px', textAlign: 'center', fontWeight: 600 }}>
                      Rs. {invoice.amount.toLocaleString()}
                    </td>
                    <td style={{ padding: '16px', textAlign: 'center', fontWeight: 600, color: 'var(--success)' }}>
